...
\begin{titlepage}
  ...
  \begin{tcolorbox}[
    ...
    \begin{flushleft}
    {\color{white!90}\sffamily\large\textbf{\faSquare\ BEST Ia\textcommabelow{s}i \,\textbullet\, Mentorat 2026}}\\[18pt]
    {\color{white}\sffamily\fontsize{52}{60}\selectfont\textbf{Training Web}}\\[8pt]
    {\color{white!92}\sffamily\Huge De la zero la site live in 2 ore}\\[20pt]
  ...
  % Cardurile celor 8 parti
  \noindent
  \begin{tcolorbox}[
    enhanced, colback=themePrereq!8, colframe=themePrereq, boxrule=0pt, leftrule=5pt,
    arc=4pt, sharp corners=downhill, rounded corners=northwest, left=10pt, right=10pt, top=6pt, bottom=6pt,
  ]
    \begin{minipage}[c]{0.06\linewidth}\color{themePrereq}\Large\faClipboardCheck\end{minipage}\hfill
    \begin{minipage}[c]{0.92\linewidth}\textbf{\color{themePrereq}Partea 0 \textbar{} Inainte de training} \,\textendash\, pre-rechizite tehnice (5 min)\end{minipage}
  \end{tcolorbox}
...
\begin{minipage}{0.94\linewidth}
  ...
  {\sffamily\large\color{black!55}Construim impreuna portofoliul Mariei Popescu.}
\end{minipage}
\par\vspace{14pt}
{\color{themeHtml!40}\hrule height 0.5pt}
\par\vspace{14pt}

Manualul nu prezinta concepte izolate. Pe parcursul celor 6 faze, fiecare strat se adauga la o pagina concreta \textendash{} portofoliul Mariei Popescu, studenta CS in Iasi. La final, fiecare participant aplica acelasi pattern pentru pagina sa proprie.
...
\textbf{\color{themeDeploy}+ Faza 4 \textendash{} Deploy.}\quad Site-ul devine accesibil la \code{maria.github.io/portfolio}. URL real, share-uibil oriunde.\\
