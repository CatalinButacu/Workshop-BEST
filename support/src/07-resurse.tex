...
\begin{itemize}[itemsep=2pt]
  ...
  \item \textbf{Cubic-Bezier editor} \textendash{} \url{https://cubic-bezier.com} (curbe de easing personalizate).
  \item \textbf{Clippy} \textendash{} \url{https://bennettfeely.com/clippy/} (\code{clip-path} vizual).
  \item \textbf{Google Webfonts Helper} \textendash{} \url{https://gwfh.mranftl.com} (self-hosting fonturi cu \code{font-display}).
  \item \textbf{Schema.org generator} \textendash{} \url{https://technicalseo.com/tools/schema-markup-generator/} (JSON-LD vizual).
  \item \textbf{XML Sitemap generator} \textendash{} \url{https://www.xml-sitemaps.com}.
\end{itemize}

% =========================================================
\section{\faRocket\ \ Topici avansate \textendash{} unde \textcommabelow{t}intim dupa training}

Sec\textcommabelow{t}iunile \emph{Bonus / Avansat} din capitolele 1\textendash{}6 introduc concepte care merita apro\-fundare independenta. Mai jos, link-urile principale pentru fiecare:

\begin{itemize}[itemsep=2pt]
  \item \textbf{CSS animations \& 3D.} \\
  \url{https://web.dev/learn/css/animations} \textendash{} cursul complet \\
  \url{https://developer.chrome.com/docs/css-ui/scroll-driven-animations} \textendash{} \code{animation-timeline}
  \item \textbf{JavaScript \textendash{} pattern-uri practice.} \\
  \url{https://javascript.info/async} \textendash{} promises, async/await \\
  \url{https://developer.mozilla.org/en-US/docs/Web/API/Intersection_Observer_API} \textendash{} IntersectionObserver \\
  \url{https://css-tricks.com/debouncing-throttling-explained-examples/} \textendash{} debounce/throttle
  \item \textbf{Performance avansat.} \\
  \url{https://web.dev/learn/performance} \textendash{} curs complet \\
  \url{https://www.thirdpartyweb.today} \textendash{} impactul scripturilor de la al\textcommabelow{t}ii \\
  \url{https://github.com/treosh/lighthouse-ci-action} \textendash{} audit automat in GitHub Actions
  \item \textbf{PWA \textcommabelow{s}i offline.} \\
  \url{https://web.dev/learn/pwa} \textendash{} Service Worker + Manifest, de la zero
  \item \textbf{Free public APIs (pentru exersat \code{fetch}).} \\
